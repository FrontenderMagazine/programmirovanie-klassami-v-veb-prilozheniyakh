...
[Попробовать на CodePen](http://codepen.io/vyushin/pen/JdrBMG)
...
[Посмотреть на CodePen](http://codepen.io/vyushin/pen/jPGpZQ)
...
<font color="red">TypeError: "Where is our split?".split is not a function</font >

Да, мы поступили очень плохо и нет нам никакого оправдания.
